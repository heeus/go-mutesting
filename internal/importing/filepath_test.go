...
func TestFilesOfArgs(t *testing.T) {
	...
	for _, test := range []struct {
		...
		// packages
		{
			[]string{"github.com/heeus/go-mutesting/internal/importing/filepathfixtures"},
			[]string{
				p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/first.go",
				p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/second.go",
				p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/third.go",
			},
		},
		{
			[]string{"github.com/heeus/go-mutesting/internal/importing/filepathfixtures/..."},
			[]string{
				...
				p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/second.go",
				p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/third.go",
				p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/secondfixturespackage/fourth.go",
			},
		},
	} {
...
func TestPackagesWithFilesOfArgs(t *testing.T) {
	...
	for _, test := range []struct {
		...
		// packages
		{
			[]string{"github.com/heeus/go-mutesting/internal/importing/filepathfixtures"},
			[]Package{{
				Name: p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures",
				Files: []string{
					p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/first.go",
					p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/second.go",
					p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/third.go",
		...
		},
		{
			...
			[]Package{
				...
				{
					Name: p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/secondfixturespackage",
					Files: []string{
						p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/secondfixturespackage/fourth.go",
					},
				},
...
func TestFilesWithExcludedDirs(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			[]string{p + "github.com/heeus/go-mutesting/internal/importing/filepathfixtures/secondfixturespackage/"},
		},
	} {
		var opts = &models.Options{}
